...
- The saved v22 patch and all ten base/candidate file hashes were verified before applying the patch here. Frozen fixture hashes still match. Prompt binding is now **1.24**, policy **1.4**. The candidate is not deployed or analytically qualified.
